...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ "./node_modules/@fortawesome/angular-fontawesome/fesm5/angular-fontawesome.js");
...
var RequestResetComponent = /** @class */ (function () {
    function RequestResetComponent(loginService) {
        this.loginService = loginService;
        this.login = {
            email: null,
            password: null,
...
var ResponseResetComponent = /** @class */ (function () {
    function ResponseResetComponent(route, respondeReset, router) {
        var _this = this;
        this.route = route;
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(signupService, activateRoute, router, Token, Auth) {
    ...
    SignupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_signup_signup_service__WEBPACK_IMPORTED_MODULE_2__["SignupService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_token_service__WEBPACK_IMPORTED_MODULE_4__["TokenService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]])
    ], SignupComponent);
...
var CatalogosComponent = /** @class */ (function () {
    ...
    CatalogosComponent.prototype.getProductoShow = function (id) {
        ...
        this.catalogoService.getProducto(id).subscribe(function (res) {
            ...
            console.log("Producto a mostrar " + _this.productoShow);
...
var MostrarDetalleProductoComponent = /** @class */ (function () {
    function MostrarDetalleProductoComponent(catalogoService, sharedService, notificacion, authService, route) {
        this.catalogoService = catalogoService;
        this.sharedService = sharedService;
        this.notificacion = notificacion;
    ...
    MostrarDetalleProductoComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            ...
            _this.getProductoShow(id);
            _this.getProductoColores(id);
        });
    ...
    MostrarDetalleProductoComponent.prototype.getProductoColores = function (id) {
        var _this = this;
        this.catalogoService.getColoresProductos(id).subscribe(function (res) {
            _this.coloresProductos = res;
            console.log(_this.coloresProductos);
        }, function (err) { return console.log(err); });
    };
    MostrarDetalleProductoComponent.prototype.onChangeColor = function ($event) {
        // console.log($event.source.name, $event.value);
        var color_id = $event.value;
    };
    MostrarDetalleProductoComponent.prototype.addPseleccionado = function (form) {
        var _this = this;
        console.log(form.value);
        if (form.valid) {
            console.log("Valid");
            if (this.loggedin) {
                this.sharedService.idProductosCatalogos.subscribe(function (id) {
                    _this.idProduCata = id;
                    console.log(_this.idProduCata);
                });
                // const inputTag = document.getElementsByName('idproducto') as HTMLInputElement;
                var id_producto = document.getElementsByName("idproducto")[0];
    ...
    //  }
    MostrarDetalleProductoComponent.prototype.enviarVariable = function (producto) {
        this.sharedService.getProductoSeleccionado(producto);
        console.log("variable enviada producto");
    };
    MostrarDetalleProductoComponent.prototype.meGusta = function (event) {
        console.log(event);
    };
...
var CarritoCompraComponent = /** @class */ (function () {
    ...
    CarritoCompraComponent.prototype.isProductos = function () {
    ...
    CarritoCompraComponent.prototype.addCarrito = function (productos) {
        ...
        this.listadoCompras.push(productos);
        var numeroProductos = this.listadoCompras.length;
    ...
    CarritoCompraComponent.prototype.getTotalCost = function () {
        ...
        this.costototal = this.listadoCompras
            .map(function (l) { return l.valorventa * l.cantidad; })
    ...
    CarritoCompraComponent.prototype.getIndice = function (id) {
        var _productoId = id;
    ...
    CarritoCompraComponent.prototype.eliminaProducto = function (indice) {
    ...
    CarritoCompraComponent.prototype.procesoComprar = function (event) {
        console.log('Comprar');
        if (this.listadoCompras.length > 0) {
    ...
    //  }
    CarritoCompraComponent.prototype.onCreateDialogProcesoCompra = function () {
        this.PrecioFinalArrayListadocomparas();
        var finalArrayTotalItem = this.FinallistadoCompras;
        console.log(finalArrayTotalItem);
    ...
    CarritoCompraComponent.prototype.PrecioFinalArrayListadocomparas = function () {
        var precioFinal = this.costototal;
        var l = this.listadoCompras;
...
var ProcesoCompraComponent = /** @class */ (function () {
    function ProcesoCompraComponent(data, _formBuilder, dialogRef, cataServes, dashboardService, dialog, sharedService, pagosServices, router, ngZone, notificacion) {
        var _this = this;
        this.data = data;
    ...
    ProcesoCompraComponent.prototype.createTableToshow = function () {
        var finalArrayTotalItem = this.data;
...
var PagosComponent = /** @class */ (function () {
    ...
    PagosComponent.prototype.pay = function (form) {
        ...
        window.Stripe.card.createToken({
            ...
            if (status === 200) {
                ...
                _this.formArray.push(form);
                console.log(_this.formArray);
                _this.agregarTokenCardForm();
                _this.chargeMoney(_this.formFinal);
            }
            else {
    ...
    PagosComponent.prototype.agregarTokenCardForm = function () {
...
var ComentarioDetalleProductoComponent = /** @class */ (function () {
    ...
    ComentarioDetalleProductoComponent.prototype.getComentario = function (id) {
        var _this = this;
        this.catalogoserve.getComentarios(id).subscribe(function (res) {
            console.log(res);
...
var CorouselSlideComponent = /** @class */ (function () {
    ...
    CorouselSlideComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbCarouselConfig"], _services_imagenes_service__WEBPACK_IMPORTED_MODULE_3__["ImagenesService"]])
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.toogleShowCatalogosComponent = function (event) {
        event.preventDefault();
        // this.clickHoverMenuTrigger.openMenu();
...
var ProductosDestacadosComponent = /** @class */ (function () {
    function ProductosDestacadosComponent(catalogoserve) {
        this.catalogoserve = catalogoserve;
    }
    ...
    ProductosDestacadosComponent.prototype.getProductosDestacados = function () {
        var _this = this;
        this.catalogoserve.getProductosDestacados().subscribe(function (res) {
            console.log(res);
            _this.productosDestacados = res;
        }, function (err) { return console.log(err); });
    };
...
var SlidebarComponent = /** @class */ (function () {
    ...
    SlidebarComponent.prototype.getMarcas = function (id) {
        ...
        var marcaCatalogo = [];
        var length = this.catalogos.length;
...
var TestomonialesComponent = /** @class */ (function () {
    function TestomonialesComponent() {
    }
...
var CatalogoServes = /** @class */ (function () {
    function CatalogoServes(http) {
        this.http = http;
        this.API_URI = "http://localhost:8000/api/catalogos";
        this.API_URIUser = "http://localhost:8000/api/user";
        this.API_URICliente = "http://localhost:8000/api/dashboard";
    ...
    CatalogoServes.prototype.getComentarios = function (id) {
...
var ImagenesService = /** @class */ (function () {
    function ImagenesService(http) {
        this.http = http;
        this.API_URI = 'http://localhost:8000/api/imagenes';
    }
...
var LoginService = /** @class */ (function () {
    ...
    function LoginService(http) {
        this.http = http;
        this.API_URI = 'http://localhost:8000/api/auth/';
    }
    // loginIn(login: Login){
...
var PagoService = /** @class */ (function () {
    ...
    function PagoService(http) {
        this.http = http;
        this.API_URI = "http://localhost:8000/api/v1/charges";
        this.API_URICompras = "http://localhost:8000/api/dashboard/compras";
        this.API_SAVE_MENSAJE = "http://localhost:8000/api/procesoCompra/mensaje";
    }
...
var ProcesoCompra = /** @class */ (function () {
    function ProcesoCompra(http) {
        this.http = http;
        this.API_URI = "http://localhost:8000/api/procesoCompra/addDireccion";
    }
...
var DashboardAdminService = /** @class */ (function () {
    function DashboardAdminService(http) {
        this.http = http;
        this.api_admin = "http://localhost:8000/api/admin";
    }
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _Catalogos_catalogos_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Catalogos/catalogos.service */ "./src/app/services/Catalogos/catalogos.service.ts");
...
var DashboardService = /** @class */ (function () {
    function DashboardService(cataServes, http) {
        ...
        this.formUser = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            ...
            identificacion_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            departamento_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            ciudad_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required)
        });
    }
    ...
    DashboardService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_Catalogos_catalogos_service__WEBPACK_IMPORTED_MODULE_3__["CatalogoServes"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])
    ], DashboardService);
